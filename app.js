...
async function loadAIProviders(){
  ...
  try{
    ...
    const names={groq:'Groq #1 · GPT-OSS 120B',groq_2:'Groq #2 · Qwen 3.8 27B',gemini:'Google Gemini Flash',openrouter:'OpenRouter Free',mistral:'Mistral',cerebras:'Cerebras',cloudflare:'Cloudflare Workers AI',deepseek:'DeepSeek Flash',openai:'OpenAI',huggingface:'Hugging Face'};
