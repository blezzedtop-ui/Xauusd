...
function bindUIActions(){
  ...
  const eurBtn=$('eurUsdPageBtn'); if(eurBtn && eurBtn.dataset.bound!=='1'){eurBtn.dataset.bound='1';eurBtn.addEventListener('click',e=>{e.preventDefault();e.stopPropagation();window.location.assign('/eurusd');});}
